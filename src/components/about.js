    ...
    render(){
        return(
            <section id="about" className="p-3 p-lg-5 d-flex align-items-center" data-section="about">
                <div className="w-100">
                    <h2 className="mb-5 title">About Me</h2>
                    ...
                    <p>Shortly after graduating from <a rel="noopener noreferrer" href="https://www.hoasen.edu.vn/en" target="_blank">Hoa Sen University</a>, I joined the engineering team at CSC (<a rel="noopener noreferrer" href="https://www.dxc.technology/vn_en" target="_blank">DXC Technology</a>) where I work on a wide variety of interesting and meaningful projects on a daily basis.</p>
                </div>
            </section>
        );
    }
